        ...
        <article className={style.container}>
            ...
            {/* {isCenter && (
                <aside className={style.containerText}>
                    ...
                    <p className={style.text}>{value.desc}</p>
                    <div className={style.containerLanguages} style={{ display: value.languages.frontend.length > 0 ? 'flex' : 'none' }}>
                    ...
                    <div className={style.containerLanguages} style={{ display: value.languages.backend.length > 0 ? 'flex' : 'none' }}>
